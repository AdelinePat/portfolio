...
const portfolio = {
  ...
  content:
    "<p><strong>Réalisation d'un CV et d'un portfolio</strong> regroupant mes projets de groupe réalisés " +
    "dans le cadre de ma formation Bachelor IT, spécialisation développement logiciel, " +
    "ainsi que mes projets personnels (certifications Dyma, projets OpenClassRooms).</p>" +
